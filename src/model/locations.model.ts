...
/**
 * `locations` — GENERATED from the database by `pgrm generate models`.
 * Regenerated output; do not hand-edit (§14.3) — customization lives in routes/hooks.
 */
export function defineLocations(sequelize: Sequelize): ModelStatic<Model> {
  return sequelize.define(
    "locations",
    {
      id: { field: "id", type: DataTypes.BIGINT, allowNull: false, primaryKey: true, autoIncrement: true },
      organisation_id: { field: "organisation_id", type: DataTypes.BIGINT, allowNull: false },
